...
#define DISPLAY_INTERVAL  100                         // interval between pose displays 300 default
...
//            Serial.println("");
//            Serial.printf("%6.2f, %6.2f, %6.2f\r\n", pose.x() * RTMATH_RAD_TO_DEGREE, pose.y() * RTMATH_RAD_TO_DEGREE, pose.z() * RTMATH_RAD_TO_DEGREE);
